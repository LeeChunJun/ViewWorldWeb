...
<html>
	...
	<head>
		...
		<link href="../style/common/show_item.css" rel="stylesheet" type="text/css">
		...
		<div class="div_head">
			...
			<div class="div_head_left">
				<ul style="list-style-type: none;">
					...
					<li>&nbsp;</li>
					<li>
						<a href="#" onclick="exitAccount()"><span class="glyphicon glyphicon-log-out"></span></a>
					</li>
					<li>&nbsp;</li>
					<li>&nbsp;</li>
					<li>用户ID:</li>
			...
			<div class="div_head_right">
				...
				<div class="dropdown" style="float: right;">
					...
					<button type="button" class="btn dropdown-toggle btn-sm" id="dropdownMenu1" data-toggle="dropdown" style="background-color: transparent; border: 1px solid #FFF; color: white;">
						<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;&nbsp;选择推荐系统&nbsp;&nbsp;&nbsp;<span class="caret"></span>
					</button>
					...
					<ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
						...
						<li role="presentation">
							<a href="#" id="base_user_recommender">依据用户的推荐</a>
						</li>
						<li role="presentation">
							<a href="#" id="base_item_recommender">依据物品的推荐</a>
						</li>
						<li role="presentation" class="divider"></li>
						<li class="dropdown-header">基于内容的推荐</li>
						<li role="presentation">
							<a href="#" id="base_content_recommender">依据物品属性相似度的推荐</a>
						</li>
						<li role="presentation" class="divider"></li>
						<li class="dropdown-header">自定义推荐</li>
						<li role="presentation">
							<a href="#" id="base_distribute_recommender">分布式推荐</a>
						</li>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div style="margin-left: 90px;">
							<input type="text" class="form-control" id="count"><label for="count">&nbsp;COUNT</label>
						</div>
						<br>
						<div style="margin-left: 90px;">
							<input type="text" class="form-control" id="format"><label for="format">&nbsp;FORMAT</label>
						</div>
					</div>
					...
					<div class="modal-footer">
						...
						<button class="btn btn-success" id="recommender_submit" type="button">进行推荐</button>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
		...
		<div class="div_item">
			<div class="div_item_desc">
				...
				<div class="div_item_play">
					<button type="button" class="btn btn-sm" style="background-color: transparent; border: 1px solid #FFF; color: white; margin: 2px;">
				...
				<div class="div_item_dispaly">
					<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=298 height=52 src="http://music.163.com/outchain/player?type=2&id=<%=itemID%>&auto=1&height=32"></iframe>
				</div>
			...
			<div class="div_recommender_analys">
				<h5>显示推荐系统名称，输入推荐参数；<br>生成推荐精度、覆盖率和推荐评估分数</h5>
				<h5>
